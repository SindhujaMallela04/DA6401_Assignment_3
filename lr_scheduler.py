...
class NoamScheduler(LRScheduler):
    ...
    def __init__(
        ...
        # Storing d_model and warmup_steps as instance attributes        
        self.d_model = d_model
        self.warmup_steps = warmup_steps
        # Calling the parent __init__
    ...
    def _get_lr_scale(self) -> float:
        ...
        """
        # Implementing and returning the Noam scale factor
    ...
    def get_lr(self) -> list[float]:
        ...
        """
        #  Returning a list of scaled LRs, one per param group
